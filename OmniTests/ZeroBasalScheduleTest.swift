...
class ZeroBasalScheduleTests: XCTestCase {
    ...
    func testZeroOneZeroSegment() {
        let entries = [
            BasalScheduleEntry(rate: 1.00, startTime: .hours(0), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(0.5), podType: dashType),
            BasalScheduleEntry(rate: 1.00, startTime: .hours(1.0), podType: dashType)
        ]
        ...
        let cmd1 = SetInsulinScheduleCommand(
            nonce: 0x494E_532E,
    ...
    func testZeroMinBasal() {
        let entries = [
            BasalScheduleEntry(rate: 0.00, startTime: .hours(0), podType: dashType),
            BasalScheduleEntry(rate: 0.05, startTime: .hours(23), podType: dashType)
        ]
    ...
    func testZeroSomeZeroBasal() {
        let entries = [
            BasalScheduleEntry(rate: 1.05, startTime: .hours(0), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(6), podType: dashType),
            BasalScheduleEntry(rate: 0.75, startTime: .hours(7.5), podType: dashType),
            BasalScheduleEntry(rate: 0.85, startTime: .hours(9), podType: dashType),
            BasalScheduleEntry(rate: 0.65, startTime: .hours(9.5), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(13.5), podType: dashType),
            BasalScheduleEntry(rate: 0.10, startTime: .hours(15.5), podType: dashType),
            BasalScheduleEntry(rate: 0.05, startTime: .hours(17), podType: dashType),
            BasalScheduleEntry(rate: 0.20, startTime: .hours(19.5), podType: dashType),
            BasalScheduleEntry(rate: 0.35, startTime: .hours(21), podType: dashType),
            BasalScheduleEntry(rate: 2.75, startTime: .hours(22.5), podType: dashType)
        ]
    ...
    func testZeroBasalTest1() {
        let entries = [
            BasalScheduleEntry(rate: 0.00, startTime: .hours(0), podType: dashType),
            BasalScheduleEntry(rate: 0.05, startTime: .hours(1), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(2), podType: dashType),
            BasalScheduleEntry(rate: 0.15, startTime: .hours(3), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(5), podType: dashType),
            BasalScheduleEntry(rate: 0.20, startTime: .hours(7), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(9), podType: dashType),
            BasalScheduleEntry(rate: 0.25, startTime: .hours(11), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(14), podType: dashType)
        ]
    ...
    func testZeroBasalTest2() {
        let entries = [
            ...
            BasalScheduleEntry(rate: 0.00, startTime: .hours(2), podType: dashType),
            BasalScheduleEntry(rate: 0.15, startTime: .hours(3), podType: dashType),
            BasalScheduleEntry(rate: 0.25, startTime: .hours(7), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(9), podType: dashType),
            BasalScheduleEntry(rate: 0.25, startTime: .hours(11), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(14), podType: dashType),
            BasalScheduleEntry(rate: 0.30, startTime: .hours(17), podType: dashType)
        ]
    ...
    func testZeroBasalTest4() {
        let entries = [
            ...
            BasalScheduleEntry(rate: 0.00, startTime: .hours(9), podType: dashType),
            BasalScheduleEntry(rate: 0.25, startTime: .hours(11), podType: dashType),
            BasalScheduleEntry(rate: 0.00, startTime: .hours(12), podType: dashType)
        ]
